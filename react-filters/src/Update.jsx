...
import { BiLoader, BiPlusCircle, BiTrash } from "react-icons/bi";
                        ...
                        <div className="md:flex sm:flex rounded shadow p-3 flex flex-col">
                            ...
                            <div className="md:flex sm:flex mb-6 p-3  rounded">
                                ...
                                <div className="md:w-1/12 px-3 sm:w-1/4 pt-6 text-center w-full">
                                    <button
                                        type="button"
                                        className="rounded py-3 px-3 bg-blue-500 hover:bg-green-600 font-bold text-white text-xl"
                            ...
                            {dimensions.map((dm, i) => (
                                ...
                                >
                                    ...
                                    <div className="md:w-1/2 px-3 sm:w-1/2">
                                        ...
                                        <input
                                            disabled
                                            className="appearance-none block w-full bg-grey-lighter text-grey-darker border border-blue-500 rounded py-3 px-4 uppercase"
                            ...
                            <div className="flex justify-center">
                                <button
                                    id="btn"
                                    type="submit"
                                    className="bg-blue-500 text-white max-w-full xs:w-full w-1/3 mx-3 p-3 text-xs rounded font-bold flex items-center justify-center md:text-lg"
                                >
